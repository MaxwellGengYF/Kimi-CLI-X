...
class EmbeddingCache:
    ...
    def put(self, file_path: str, embeddings: np.ndarray):
...
class TextSearchIndex:
    ...
    def model(self):
        ...
        if self._model is None:
            ...
            with warnings.catch_warnings():
                ...
                self._model = ST(self.model_name, device='cpu')
    ...
    def add_file(self, file_path: str) -> int:
        ...
        indices, texts = zip(*non_empty_lines)
        texts = list(texts)
    ...
    def add_folder_parallel(self, folder_path: str, max_workers: Optional[int] = None,
        ...
        files_needing_embeddings = {}  # file_path -> list of (idx_in_batch, text)
